<template>
  <div class="card"
    ...
    <div class="card-image" style="margin-bottom:0px;padding-bottom:0px;" v-if="$slots.image">
    ...
    <div v-if="$slots.default" class="card-body" style="padding-top:10px;" :class="cardBodyClasses">
      <slot></slot>
    </div>
